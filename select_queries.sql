...
SELECT last_name, first_name, member_id FROM member WHERE gender = 'männlich' ORDER BY last_name ASC; 

-- Counts the number of female members in total
SELECT COUNT(*) AS 'female members' FROM member WHERE gender = 'weiblich'; 
...
-- Lists all accommodation that cost between 10 and 70€.
